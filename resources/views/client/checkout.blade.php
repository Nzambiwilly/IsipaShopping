<x-layouts.app :title="'Checkout | ISIPA Shopping'">
    <section class="mb-6">
        <a href="{{ route('panier.index') }}" class="mb-3 inline-flex items-center gap-2 rounded-md border border-[#3A2424] bg-[#1a0808] px-3 py-2 text-sm font-medium text-white transition hover:border-[#EAF270]">
